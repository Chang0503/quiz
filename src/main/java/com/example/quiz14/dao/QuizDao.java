...
public interface QuizDao extends JpaRepository<Quiz, Integer> {
	...
	@Transactional
	@Modifying
	@Query(value = "INSERT INTO quiz (title, direction, start_date, end_date, published) "//
			+ " VALUES (:title, :direction, :startDate, :endDate, :published)", nativeQuery = true)
	public void create(//
	...
	@Transactional
	@Modifying
	@Query(value = "update quiz set title = :title, direction = :direction, "//
